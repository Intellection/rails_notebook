...
railsNB.renderTableData      = function( tableData, element ){
  require(["jquery", "/kernelspecs/rails_notebook/dagre-d3.js", "/kernelspecs/rails_notebook/d3.js"], function ( $ , dagreD3 , d3 ) {
      ...
      var numberOfRows = tableDataVar[0].length; // First row is just the column name
      var buildHtmlOutput = "<div style = 'text-align: center;'><span style='font-size:32px;color:#007acc;font-style:italic;'><u><font style = 'font-family:Palatino'>" + "TEST" + "</font></u></span>";
